...
export default function MyLeaveRequestDetailsPage() {
    ...
    const { request, loading, error } = useMyLeaveRequestDetails(params.id);
        ...
        <Container size="sm" py="lg" px={{ base: "xs", sm: "md" }}>
            <Stack gap="lg">
                <Group justify="space-between">
                    <Title order={2}>My Leave Request</Title>
                    <Button
                        onClick={() => router.back()}
                        variant="subtle"
                        leftSection={<IconArrowLeft size={16} />}
                ...
                <Paper p={{ base: "md", sm: "xl" }} radius="md" withBorder>
                    <Stack gap="lg">
                        <Group justify="space-between" align="flex-start">
                            ...
                            <Badge variant="dot" color={statusColors[request.status]} size="lg">
                        ...
                        <Stack gap="md">
                            ...
                            <InfoRow
                                ...
                                label="Manager"
                                value={manager ? `${manager.firstName} ${manager.lastName}` : "No manager assigned"}
                            />
                            <InfoRow
